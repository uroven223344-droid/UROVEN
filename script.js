...
<body>
    <div id="app"></div>
    <button onclick="runApp()" style="position:fixed;bottom:20px;right:20px;background:#c9a959;color:#000;border:none;padding:12px 24px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;z-index:9999;">
        ▶️ ЗАПУСТИТЬ
    </button>
    <script>
    function runApp() {
        ...
        // Убираем кнопку запуска после запуска
        document.querySelector('button[onclick="runApp()"]')?.remove();
    }
    </script>
</body>
</html>
